...
prog_start:	/* empty */		{printf("prog_start -> epsilon\n");}
		| functions prog_start	{printf("prog_start -> functions beg\n");}
;
...
identifiers:	ident	{printf("identifier -> ident\n");}
				| identifiers COMMA identifiers	{printf("identifiers -> ident COMMA identifiers\n");}
;

number:		NUMBER	{printf("number -> NUMBER\n");};
...
expression:		multiplicative-expression	{printf("expression -> multiplicative_expression\n");}
				| multiplicative-expression ADD multiplicative_expression	{printf("expression -> multiplicative_expression ADD multiplicative_expression\n");}
				| multiplicative-expression SUB multiplicative_expression	{printf("expression -> multiplicative_expression SUB multiplicative_expression\n");}
;
...
int yyerror(const char* s) {
	...
	printf("Syntax error at line %d: Symbol %s was not expected\n", line, s_temp);
}
